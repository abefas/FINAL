...
plot_paths(ivt_0, line_color='#FFA07A', marker_color='#FFA07A', linestyle='-', label='Truck routes - $M_T=344.91$')

# Plot motorbike paths with special handling for depot-to-customer connections
plot_paths(ivt_1, line_color='green', marker_color='green', linestyle='-', label='Motorbike routes - $M_M=337.98$', special_handling=True)

# Plot drone paths with dashed gray lines and blue nodes
plot_paths(ivt_2, line_color='gray', marker_color='blue', linestyle='--', label='UAV routes - $M_D=342.05$')
