...
ivt_0 = pd.read_csv("prox07-15-20-20_ND1-ivt_0.csv")  # Truck paths
ivt_1 = pd.read_csv("prox07-15-20-20_ND1-ivt_1.csv")  # Motorbike paths
ivt_2 = pd.read_csv("prox07-15-20-20_ND1-ivt_2.csv")  # Drone paths
...
plot_paths(ivt_0, line_color='#FFA07A', marker_color='#FFA07A', linestyle='-', label='Truck routes - $M_T=420.02$')

# Plot motorbike paths with special handling for depot-to-customer connections
plot_paths(ivt_1, line_color='green', marker_color='green', linestyle='-', label='Motorbike routes - $M_M=403.18$', special_handling=True)

# Plot drone paths with dashed gray lines and blue nodes
plot_paths(ivt_2, line_color='gray', marker_color='blue', linestyle='--', label='UAV routes - $M_D=413.66$')
...
plt.title("MD-mfcmTSP heuristic (improved)")
