        ...
        while(  G->a_depots[IDEPOT].n_VT[0] != 0
            ...
            while(index_nn < nn_length - 1){
                ...
                if(successive_nodes && listLength(successive_nodes) == VT[type].capacity){
                    ...
                    linkToTail(&l1, l2);
                    double dep_ms = 
                        get_makespan_depot_VT(G, l1, G->a_depots[IDEPOT].n_VT[type], VT[type].IVT);
                    deleteList(&l1);
                    l2 = NULL;
                    ...
                    //add local opt for new route with removed successive_nodes
                    double IDEPOT_NEW_MS = get_makespan_depot_VT(G, l1, G->a_depots[IDEPOT].n_VT[0], 0);
                    deleteList(&l1);
                    l2 = NULL;
            ...
            if(min_ms < R->a_VT[0].a_depots[IDEPOT].makespan - epsilon){
                ...
                R->a_VT[type].a_depots[IDEPOT].makespan = 
                    get_makespan_depot_VT(G, R->a_VT[type].a_depots[IDEPOT].routelist, G->a_depots[IDEPOT].n_VT[type], VT[type].IVT);

                R->a_VT[0].a_depots[IDEPOT].makespan = 
                    get_makespan_depot_VT(G, R->a_VT[0].a_depots[IDEPOT].routelist, G->a_depots[IDEPOT].n_VT[0], 0);
