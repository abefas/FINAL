...
void antSolution(SON *G, VType VT, d_solution *Ra, int **K, double *t, int *da_access, int *remaining, 
        int n_size, int n_prim, double a, double b);


int selectDepot(d_solution *Ra, SON *G, int *v_free, int **K, double *phMatrix, int n_size, int n_prim);
...
void heuristic_v1_2(SON *G, VType *VT, asolution *R, int **da_access, int *remaining);
