...
%	\par 
	...
	\begin{figure}[h]
		...
		\begin{subfigure}{0.33\textwidth}
			\centering
			\includegraphics[scale=0.42]{p07_NM1_init}\;
			\caption{$N_M=1$}
			\label{fig:p07_NM1}
		\end{subfigure}
		\begin{subfigure}{0.33\textwidth}
			\centering
			\includegraphics[scale=0.42]{p07_NM2_init}\;
			\caption{$N_M=2$}
			\label{fig:p07_NM2}
		\end{subfigure}
		\begin{subfigure}{0.33\textwidth}
			\centering
			\includegraphics[scale=0.42]{p07_NM4_init}\;
			\caption{$N_M=4$}
			\label{fig:p07_NM4}
		\end{subfigure}
	...
	\begin{figure}[h]
		...
		\begin{subfigure}{0.33\textwidth}
			\centering
			\includegraphics[scale=0.42]{p11_NM1_init}\;
			\caption{Instance 11 - $N_M=1$}
			\label{fig:p11_NM1}
		\end{subfigure}
		\begin{subfigure}{0.33\textwidth}
			\centering
			\includegraphics[scale=0.42]{p11_NM2_init}\;
			\caption{Instance 11 - $N_M=2$}
			\label{fig:p11_NM2}
		\end{subfigure}
		\begin{subfigure}{0.33\textwidth}
			\centering
			\includegraphics[scale=0.42]{p11_NM4_init}\;
	...
	\begin{figure}[h]
		...
		\begin{subfigure}{0.33\textwidth}
			\centering
			\includegraphics[scale=0.42]{moto_avg_NM1}\;
			\caption{$N_M=1$}
			\label{fig:moto_avg_NM1}
		\end{subfigure}
		\begin{subfigure}{0.33\textwidth}
			\centering
			\includegraphics[scale=0.42]{moto_avg_NM2}\;
			\caption{$N_M=2$}
			\label{fig:moto_avg_NM2}
		\end{subfigure}
		\begin{subfigure}{0.33\textwidth}
			\centering
			\includegraphics[scale=0.42]{moto_avg_NM4}\;
			\caption{$N_M=4$}
			\label{fig:moto_avg_NM4}
		\end{subfigure}
		\caption{Average makespan among instances 1-11 for varying motorbike capacity}
